...
const stories = [
  {
    ...
    description:
      "Good Karma Golbal Foundation  supports Gayatri from Hampi with daily meals, helping her stay focused on studies and dream of becoming a bank manager and poet.",
    image: g1,
  ...
  },
  {
    ...
    description:
      "With nutritious meals every day, Rahul now attends school regularly and dreams of becoming an engineer.",
    image: g2,
    tag: "Future Engineer",
  },
  {
    ...
    description:
      "A simple meal has transformed Meena’s classroom experience and confidence.",
    image: g3,
    tag: "Future Leader",
  },
];
